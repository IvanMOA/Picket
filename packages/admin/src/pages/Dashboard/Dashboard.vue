  ...
  <AdminLayout>
    ...
    <div class="flex items-center space-x-4">
      <button
        ...
        <svg class="mr-2 text-gray-400" fill="currentColor" height="20" viewBox="0 0 1792 1792" width="20"
        ...
        Last month
        <svg class="ml-2 text-gray-400" fill="currentColor" height="20" viewBox="0 0 1792 1792" width="20"
             xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            <div
              ...
              <div class="flex items-end text-xs">
                ...
                <span class="flex items-center">
                                            <svg class="h-3 text-green-500" fill="currentColor" height="20"
                                                 viewBox="0 0 1792 1792"
          ...
          <div class="dark:text-white">
            ...
            <div class="flex items-center text-sm space-x-12 md:space-x-24 justify-between">
              ...
              <div class="flex items-end text-xs">
                434
                <span class="flex items-center">
                                            <svg class="h-3 text-red-500 rotate-180 transform" fill="currentColor"
                                                 height="20"
                                                 viewBox="0 0 1792 1792" width="20"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                  d="M1675 971q0 51-37 90l-75 75q-38 38-91 38-54 0-90-38l-294-293v704q0 52-37.5 84.5t-90.5 32.5h-128q-53 0-90.5-32.5t-37.5-84.5v-704l-294 293q-36 38-90 38t-90-38l-75-75q-38-38-38-90 0-53 38-91l651-651q35-37 90-37 54 0 91 37l651 651q37 39 37 91z">
                                                </path>
        ...
        <div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
          ...
          <div class="flex items-end space-x-2 my-6">
            ...
            <span class="text-red-500 text-xl font-bold flex items-center">
                                    <svg class="h-3 rotate-180 transform" fill="currentColor" height="20"
                                         viewBox="0 0 1792 1792"
                                         width="20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                          d="M1675 971q0 51-37 90l-75 75q-38 38-91 38-54 0-90-38l-294-293v704q0 52-37.5 84.5t-90.5 32.5h-128q-53 0-90.5-32.5t-37.5-84.5v-704l-294 293q-36 38-90 38t-90-38l-75-75q-38-38-38-90 0-53 38-91l651-651q35-37 90-37 54 0 91 37l651 651q37 39 37 91z">
      ...
      <div class="w-full">
        <div class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
          ...
          <div class="flex items-end space-x-2 my-6">
            ...
            <span class="text-red-500 text-xl font-bold flex items-center">
                                    <svg class="h-3 transform rotate-180" fill="currentColor" height="20"
                                         viewBox="0 0 1792 1792"
                                         width="20" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                          d="M1675 971q0 51-37 90l-75 75q-38 38-91 38-54 0-90-38l-294-293v704q0 52-37.5 84.5t-90.5 32.5h-128q-53 0-90.5-32.5t-37.5-84.5v-704l-294 293q-36 38-90 38t-90-38l-75-75q-38-38-38-90 0-53 38-91l651-651q35-37 90-37 54 0 91 37l651 651q37 39 37 91z">
