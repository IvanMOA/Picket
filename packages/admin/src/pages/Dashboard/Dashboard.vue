...
<template>
  <AdminLayout>
    <h1 class="text-4xl font-semibold text-gray-800 dark:text-white">
      {{ t("dashboard_welcome", { name: "Axel" }) }}
    </h1>
    <h2 class="text-md text-gray-400">
      {{ t("dashboard_description") }}
    </h2>
    <div
      class="flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row"
    >
      <div class="w-full md:w-6/12">
        <div
          class="shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden"
        >
          <a class="w-full h-full block" href="#">
            <div class="flex items-center justify-between px-4 py-6 space-x-4">
              <div class="flex items-center">
                ...
                <p
                  class="text-sm text-gray-700 dark:text-white ml-2 font-semibold border-b border-gray-200"
                >
                  Level 2 Ambassador
                </p>
              </div>
            ...
            <div class="w-full h-3 bg-gray-100">
              <div
                class="w-2/5 h-full text-center text-xs text-white bg-green-400"
              ></div>
            </div>
          </a>
        </div>
      ...
      <div class="flex items-center w-full md:w-1/2 space-x-4">
        <div class="w-1/2">
          <div
            class="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative"
          >
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
      <div class="w-full">
        ...
        >
          <p
            class="text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200"
          >
            Project Reffered
          </p>
          ...
          <div class="dark:text-white">
            ...
            <div
              class="flex items-center text-sm space-x-12 md:space-x-24 justify-between"
            >
              <p>New visitor</p>
              <div class="flex items-end text-xs">
                45
