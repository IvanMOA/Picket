...
<template>
  <div
    class="relative z-20 flex flex-col justify-between items-center h-full px-3 md:w-full"
  >
    <div
      class="relative p-1 flex items-center w-full h-full space-x-4 justify-between"
    >
      <div class="h-5/6">
      ...
      <div class="flex items-center space-x-3">
        ...
        <el-dropdown data-testid="profile-btn" trigger="click">
          <button
            class="flex items-center text-gray-500 dark:text-white text-md"
          >
